                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('update_product', $product->id) }}" class="btn btn-primary">
                                            Edit </a> |
                                        <a href="{{ route('delete_product', $product->id) }}" class="btn btn-danger"> Delete
                                        </a>
                                    </td>
                                </tr>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            ...
                            Designed By <a href="https://htmlcodex.com">Kisotama</a>
                            <br>Distributed By: <a href="https://themewagon.com" target="_blank">Kisohehe</a>
                        </div>
                    </div>
                </div>
            </div>
