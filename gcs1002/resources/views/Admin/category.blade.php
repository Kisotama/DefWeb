            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <a href="{{ url('admin/admin') }}" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Admin Manage</a>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$cat->cat_name}}</td>
                                    <td>
                                        <a href="{{ route('update_product', $cat->id) }}" class="btn btn-primary">
                                            Edit </a> |
                                        <a href="{{ route('delete_cat', $cat->id) }}" class="btn btn-danger"> Delete
                                        </a>
